...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        let modelURL = Bundle.main.url(forResource: "FinalWork", withExtension: "momd")!
    ...
    lazy var persistenceStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("FinalWork.sqlite")
        var failureReason = ""
        do{
